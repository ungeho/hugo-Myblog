...
変数$a$が2のべき乗であるときには期待通りの結果になる一方、そうでないときには2進倍精度浮動小数点数で表現可能な**近傍の値に丸められた**結果になっているように見えます。  
したがって、これは2進の倍精度浮動小数点演算における**丸め誤差、特に$x - a$の段階での情報落ち**によるものと推測出来ます。  
  
また、一般的には丸め方式は **最近接丸め（偶数丸め）** であり、演算結果は **最も近い表現可能な値** に丸められます。本結果では繰り上げが生じているように見えますが、丸めの結果は状況により繰り上げまたは切り捨てのいずれにもなり得ます。  
さらに、環境や丸めモードの設定、最適化等によっては **異なる結果** となる場合があります。
