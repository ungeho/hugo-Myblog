...
- `memo`
  - 短めのメモ向け
- `waymark`
  - Waymark Preset シリーズ向け。画像とコードを繰り返し並べやすい
...
- Waymark Preset 記事なら `-type waymark -bilingual` で日本語 / 英語の雛形をまとめて作れる

## Waymark Preset 記事テンプレート

Waymark Preset シリーズ用に、専用 archetype を用意している。

生成される記事タイトルは `[Waymark Preset] タイトル` の形式を前提にしている。  
このテンプレートで作成した記事は、`Waymark Preset` シリーズの記事として扱う。
...
Waymark Preset 記事では、導入方法を 1 つにまとめるより、目的別に分けると書きやすい。
